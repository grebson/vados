    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'User with this email address already exists.'}, help_text='Required. 128 characters or fewer. Letters, digits and @/./-/_ only.', max_length=128, unique=True, verbose_name='email address')),
                ...
                ('is_principal', models.BooleanField(default=False, help_text='Designates whether this user should be treated as principal.', verbose_name='principal status')),
